...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-dendroextras-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-dendroextras-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-dendroextras
# for installing globally
pixi global install r-dendroextras
```
...
It is possible to list all of the versions of `r-dendroextras` available on your platform:
...
```
pixi search r-dendroextras --channel conda-forge
```
